...
class _HawkFabMenuState extends State<HawkFabMenu>
  ...
  void initState() {
    super.initState();
    _iconAnimationCtrl = AnimationController(vsync: this, duration: _duration);
  ...
  Widget _buildMenuItemList() {
    return Positioned(
      ...
      child: ScaleTransition(
        scale: AnimationController(vsync: this, value: 0.7, duration: _duration)
          ..forward(),
  ...
  Widget _buildBlurWidget() {
    return InkWell(
      ...
      child: BackdropFilter(
        ...
        child: Container(color: widget.backgroundColor ?? Colors.black12),
      ),
    );
  }
...
class _MenuItemWidget extends StatelessWidget {
  ...
  const _MenuItemWidget({required this.item, required this.toggleMenu});
