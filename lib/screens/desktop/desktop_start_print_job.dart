...
class _StartPrintJobScreenState extends ConsumerState<StartPrintJobScreen> {
  ...
  double? get _maxQty {
    print("stock item: ${_stockItem}, consumed: ${_stockItem?.consumed}");

    return _stockItem != null
        ? (_stockItem?.consumed != null
            ? _stockItem!.quantity - _stockItem!.consumed!
            : 0)
        : null;
  } // Can only use up to what's in this batch
                    ...
                    child: Center(
                      child: Text(
                        ...
                        style: TextStyle(
                          fontSize: 8,
                          fontWeight: FontWeight.w800,
                          color: isDone ? _T.white : _T.slate500,
                        ),
                      ),
                    ),
                  ),
            ...
            child: GestureDetector(
              ...
              child: AnimatedContainer(
                ...
                decoration: BoxDecoration(
                  ...
                  border: Border.all(
                    color:
                        barcodeMode ? _T.amber.withOpacity(0.4) : _T.slate200,
                  ),
                ),
                child: Row(
                  mainAxisSize: MainAxisSize.min,
    ...
    return Padding(
      ...
      child: AnimatedBuilder(
        ...
        builder: (_, __) {
          ...
          final opacity =
              0.35 + 0.45 * (1 - (phase - 0.5).abs() * 2).clamp(0.0, 1.0);
          return Opacity(
            opacity: opacity,
            child: Container(
              height: 58,
...
class _MaterialNameTile extends StatefulWidget {
  ...
  @override
  State<_MaterialNameTile> createState() => _MaterialNameTileState();
}
                ...
                Expanded(
                  child: Column(
                    ...
                    children: [
                      ...
                      Text(
                        '${_fmtQty(m.currentStock)} ${m.unitShort} available',
                        style: const TextStyle(
                          fontSize: 11,
                          color: _T.slate400,
                        ),
...
class _BarcodeResultTile extends StatefulWidget {
  ...
  @override
  State<_BarcodeResultTile> createState() => _BarcodeResultTileState();
}
...
class _StockItemTile extends StatefulWidget {
  ...
  @override
  State<_StockItemTile> createState() => _StockItemTileState();
}
...
class _StockItemTileState extends State<_StockItemTile> {
  ...
  Widget build(BuildContext context) {
    ...
    final failedToFetchBatchLevel = t.consumed == null;
      ...
      child: GestureDetector(
        ...
        child: Container(
          decoration: BoxDecoration(
            color:
                selected
                    ? (failedToFetchBatchLevel
                        ? _T.red50.withValues(alpha: 0.5)
                        : _T.purple50)
                    : _hovered
                    ? _T.slate50
                    : _T.white,
          ...
          child: AnimatedContainer(
            ...
            decoration: BoxDecoration(
              ...
              border: Border.all(
                color:
                    selected
                        ? (failedToFetchBatchLevel ? _T.red : _T.purple)
                            .withOpacity(0.4)
                        : _T.slate200,
                width: selected ? 1.5 : 1,
              ),
              boxShadow:
                  selected
                      ? [
                        BoxShadow(
                          color: (failedToFetchBatchLevel ? _T.red : _T.purple)
                              .withOpacity(0.08),
                          blurRadius: 8,
                    ...
                    Expanded(
                      child: Column(
                        ...
                        children: [
                          Text(
                            failedToFetchBatchLevel
                                ? 'Failed to fetch batch level'
                                : '${_fmtQty(t.quantity - t.consumed!)} ${m.unitShort}',
                            style: TextStyle(
                              fontSize: 13.5,
                              fontWeight: FontWeight.w800,
                              color:
          ...
          if (hasError && !widget.qtyValid) ...[
            ...
            Row(
              children: const [
                ...
                SizedBox(width: 4),
                Text(
                  'Quantity exceeds available stock in this item',
                  style: TextStyle(
                    fontSize: 11,
                    color: _T.red,
                    fontWeight: FontWeight.w500,
  ...
  Widget build(BuildContext context) => Center(
    child: Column(
      ...
      children: [
        ...
        Text(
          subtitle,
          style: const TextStyle(fontSize: 11, color: _T.slate300),
        ),
      ],
    ),
  );
