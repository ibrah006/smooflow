...
;     
;          
; Description:  This is the installer script for Smooflow, b0168.
;
;********************************************************************
; Revision History
;
...
; -----------------------------------------------------------------------------------
;UninstallDisplayName="Smooflow v4.0.5.0168 Uninstall"                                  
...
; Create the "Start Smooflow" checkbox on the last page of the installer.
...
;Filename: {cmd}; Parameters: "RENAME "" {app}""\unins000.exe"" ""uninstall_Smooflow.exe"""; StatusMsg: Installing uninstaller for Smooflow...; Flags: RunHidden WaitUntilTerminated

; Give the user the option to run Smooflow after the installation has completed.
Filename: "{app}\{#MyAppExeName}"; Description: "{cm:LaunchProgram,{#MyAppName}}"; Flags: nowait postinstall skipifsilent



[UninstallDelete]
; The last step of the Uninstaller will be to delete the new Smooflow folder
